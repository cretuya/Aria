          ...
          success: function(contents){
            $('.tabtitle').text($id);
              $.each(contents, function(key, value)
              {
                ...
                console.log(song);
              $('.tablist').append('<li class="list-group-item"><label>'+value.song_audio+'</label><audio controls><source src="{{asset("assets/music/Boys Like Girls - Hero Heroine (acoustic) w_ lyrics.mp3")}}" type="audio/mpeg"></audio><button class="btn pull-right delete" value="'+value.song_id+'"><span class="fa fa-close"></span></button><button class="btn pull-right edit" data-toggle="modal"  data-desc="'+value.song_desc+'" data-id="'+value.song_id+'"><span class="fa fa-pencil"></span></button></li>'); 
