...
// // console.log(audio);
            $('.nlist h3').remove();
            $('.nlist').append('<div align="center"><div class="row"><div class="col-md-7"><label>'+data.song.song_title+'</label><br><audio controls><source src="'+audio+'" type="audio/mpeg"></audio></div><div class="col-md-2"><button type="button" class="removenlist" data-id="'+data.song.song_id+'">Remove</button></div></div></div>');
            $('.rsongs').remove();
          ...
          success: function(data){
            console.log(data);
              $.each(data, function(key, value)
              {
                ...
                $('.nrecommend').append('<div align="center"><div class="row"><div class="col-md-7"><label>'+value.song_title+'</label><br><audio controls><source src="'+audio+'" type="audio/mpeg"></audio></div><div class="col-md-2"><button type="button" class="removenlist" data-id="'+value.song_id+'">Add</button></div></div></div>');
